...
cout << "wyjscie dla [0,0]  " << " oczekiwana "<< d1 << " " << f(Z) << endl;
s1 = 0;
s2 = 0;
Z = 0;
...
cout << "wyjscie dla [1,1] " << " oczekiwana " << d2 << " " << f(Z)  << endl;
...
//	cout << E << " blad sumaryczny 2" << endl;
	...
	cout << "wyjscie dla [0,1] " << " oczekiwana " << d3<<" "<< f(Z) << endl;
	...
	cout << "wyjscie dla [1,0] " << " oczekiwana " << d4<< " " << f(Z)  << endl;
